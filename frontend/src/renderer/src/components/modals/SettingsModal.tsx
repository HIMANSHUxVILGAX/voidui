              ...
              <div className="flex-1 flex overflow-hidden">
                ...
                <div className="w-44 border-r border-white/10 p-3 space-y-1.5 shrink-0 bg-black/40">
                  <button
                    ...
                    className={`w-full px-3 py-2 rounded-xl text-left text-xs font-mono font-bold transition-all border ${
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="flex items-start justify-between bg-black/30 border border-studio-border p-3.5 rounded-lg">
                        <div className="space-y-1 pr-4">
                          ...
                          <p className="text-[10px] text-zinc-400 leading-relaxed font-sans">
                            Grant NoAsh native writing permissions to quarantine, fix, or purge high-risk threat binaries on this host PC.
                          </p>
                        </div>
                        <button
                          onClick={() => setSystemRemediation(prev => !prev)}
                          className={`px-3 py-1.5 rounded font-mono text-xs font-bold uppercase border transition-all ${
                            systemRemediation
                        ...
                        <div className="flex space-x-1.5 pt-1">
                          {['storage', 'custom', 'full'].map((level) => (
                            <button
                              ...
                              className={`px-3.5 py-1.5 rounded font-mono text-[10px] font-bold uppercase border transition-all ${
                                systemAccessLevel === level
                  ...
                  {activeSettingsTab === 'help' && (
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3 font-sans">
                        ...
                        <div className="space-y-1 bg-black/25 p-3 rounded border border-studio-border">
                          <span className="text-xs font-bold text-zinc-200">How to configure SuperForge AI?</span>
                          <p className="text-[10px] text-zinc-400 leading-relaxed">
